...
export function PublishModal({ onCancel, onPublishConfirm }: PublishModalProps) {
                    ...
                    {step === 'enter' ? (
                        ...
                        <>
                            <div className="flex gap-3 justify-center mb-6">
                                {confirmPin.map((digit, index) => (
                                    <input
                                        ...
                                        className={`w-14 h-14 text-center text-2xl font-semibold border-2 rounded-lg focus:outline-none focus:ring-2 transition-colors ${error
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button type="submit" className="flex-1" disabled={!isConfirmComplete}>
                                    Publish Form
                                </Button>
                            </div>
                        </>
